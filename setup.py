...
class CMakeBuild(BuildExtension):
    ...
    def build_extension(self, ext) -> None:
        ...
        cmake_args = [
            ...
            "-DCMAKE_C_FLAGS=-march=armv9-a+fp+nosve+sve+sve2+i8mm+f32mm+f64mm+fp16+bf16+fp16fml+crc",
            "-DCMAKE_CXX_FLAGS=-march=armv9-a+fp+nosve+sve+sve2+i8mm+f32mm+f64mm+fp16+bf16+fp16fml+crc",
        ]
